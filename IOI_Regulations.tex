...
\usepackage[a4paper, left=18mm, right=20mm, top=15mm, bottom=20mm]{geometry}
...
\Statute{1.3}{Throughout these regulations all words and phrases shall have meanings as deﬁned in the section where they appear in \textbf{bold}.}
...
\Statute{2.6}{An \textbf{Invited Observer} is a representative of:
\begin{itemize}
...
\Statute{3.1}{The \textbf{General Assembly} is a temporary, short-term committee during \IOIn[], which is composed of the Delegation Leaders and the Deputy Leaders of all Participating Countries. The GA is the owner of the IOI.}
...
\end{itemize}
GA meetings must \emph{not} be attended by Contestants.}
...
\begin{itemize}
    ...
    \item One immediate \emph{Past Host representative} of \IOIn[-1];
    \item One \emph{Present Host representative} of \IOIn[];
    \item Three immediate \emph{Future} or \emph{Candidate Host representatives} of \IOIn[+1], \IOIn[+2], and \IOIn[+3];
    \item Five other \emph{elected representatives};
...
\begin{itemize}
    ...
    \item Voting, in an election with n positions, follows the voting procedure in \Link{A3.2} for multiple options:
    \begin{itemize}
...
An additional \textbf{Registration Fee} may be payable, by Participants or Delegations, during \IOIn[].}
